...
contract VRFCoordinatorV2Mock is VRFCoordinatorV2Interface {
  ...
  mapping(uint64 => address[]) subscriptions_consumers; /* subId */ /* consumers */
  ...
  function createSubscription() external override returns (uint64 _subId) {
    ...
    subscriptions_consumers[_subId] = new address[](0);
    ...
    )
  {
    ...
    return (s_subscriptions[_subId].balance, 0, s_subscriptions[_subId].owner, subscriptions_consumers[_subId]);
  }
  ...
  function addConsumer(uint64 _subId, address _consumer) external override {
    ...
    subscriptions_consumers[_subId].push(_consumer);
  }
